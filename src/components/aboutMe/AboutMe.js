				...
				<Col className="ml-10">
					<Row className="aboutme__block">
						...
						<p className="aboutme__descr">
							...
							<br />
							Lorem ipsum dolor, sit amet consectetur adipisicing elit. Amet nam, quos, et voluptas
							illum delectus, vel quod sed eveniet beatae laboriosam quaerat non molestias facilis
							nulla. Dolore saepe est ad sint ab, repudiandae cumque minima quaerat reiciendis quis
							nam libero dolor quisquam voluptatibus a ipsum? Cupiditate dolor soluta fuga harum sed
							molestiae aliquid delectus impedit. Quisquam iure consequatur magnam omnis!
							<br />
							...
							communication with machines has only intensified. What exactly do I do? A little more
							about this:
						</p>
					</Row>
					<Row className="aboutme__block aboutme__block_wrapper">
						<AboutCard cardData={data.cardData} />
					</Row>
				</Col>
			</Container>
		</section>
